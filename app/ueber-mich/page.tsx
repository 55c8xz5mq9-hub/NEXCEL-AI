          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-[#FFFFFF] mb-4 tracking-tight">
                Wir entwickeln Systeme, die Unternehmen autonom steuern.
              </h1>
...
Wir arbeiten nicht mit Baukästen. Jedes System entsteht exakt für Ihre Struktur, Ihre Abläufe und Ihr Wachstum.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="relative py-24 md:py-32 px-6">
        <div className="relative z-10 max-w-6xl mx-auto">
          ...
          >
            Wie wir <span className="text-[#6B2DB8]" style={{ textShadow: "0 0 20px rgba(107, 45, 184, 0.4)" }}>arbeiten</span>
          </motion.h2>
