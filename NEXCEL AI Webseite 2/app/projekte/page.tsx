...
const projects = [
  ...
  },
  {
    ...
    description: "Neben komplexen Systemen entwickle ich auch Webauftritte, die zur technischen Tiefe passen. Fokus: klares Design, Performance und eine Struktur, die später mit Systemen verknüpft werden kann – zum Beispiel mit CRM, Buchungsstrecken oder Dashboards.",
    highlights: [
...
export default function ProjektePage() {
  return (
    <main className="relative min-h-screen overflow-hidden">
      <Navigation />
      <section className="relative min-h-[60vh] flex items-center justify-center py-32 px-6">
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl lg:text-3xl text-[#E5E7EB] font-light max-w-4xl mx-auto leading-relaxed break-words">
              Hier siehst du eine Auswahl von Systemen, die ich für reale Unternehmensprozesse konzipiert und entwickelt habe – von KI-gestützter Logistik bis zu individuellen Operating-Systemen.
            </p>
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#FFFFFF] mb-6 tracking-tight break-words">
              Bereit für dein <span className="text-[#A45CFF]" style={{ textShadow: "0 0 20px rgba(164, 92, 255, 0.4)" }}>eigenes System</span>?
            </h2>
            <p className="text-lg md:text-xl text-[#E5E7EB] font-light leading-relaxed mb-8 max-w-2xl mx-auto break-words">
              Wenn du dir vorstellen kannst, ein ähnliches System für dein Unternehmen aufzubauen, lass uns über deine Prozesse sprechen. Ich zeige dir transparent, was möglich ist.
            </p>
            <Link href="/kontakt" prefetch={true}>
              <motion.button
                className="neural-button-primary px-8 sm:px-10 py-4 sm:py-5 rounded-neural font-semibold text-sm sm:text-base whitespace-nowrap"
                style={{
                  background: "#0C0F1A",
                  border: "1px solid rgba(164, 92, 255, 0.3)",
                  boxShadow: "0 4px 16px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.05)",
                ...
                whileHover={{
                  ...
                  boxShadow: "0 6px 24px rgba(0, 0, 0, 0.6), inset 0 1px 0 rgba(255, 255, 255, 0.1), 0 0 30px rgba(164, 92, 255, 0.25)",
                }}
                whileTap={{ scale: 0.98 }}
              >
