...
const socialLinks = [
  {
    name: "LinkedIn",
    href: "https://linkedin.com/company/nexcel-ai",
    icon: (
      ...
      {!isContactPage && !isProjektePage && !isImpressumPage && !isDemoPage && (
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            <motion.h3
              className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#FFFFFF] mb-4 tracking-tight"
            ...
            <motion.p
              className="text-[#E5E7EB] text-base md:text-lg font-light leading-relaxed mb-8 max-w-2xl mx-auto"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.8, delay: 0.1 }}
            >
              In einer kostenlosen Systemanalyse prüfe ich, welche Prozesse in deinem Unternehmen sofort digitalisiert und durch KI gesteuert werden können.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <Link href="/kontakt" prefetch={true}>
                <motion.button
                  className="relative px-10 py-5 rounded-lg font-semibold text-base text-white overflow-hidden group"
                  style={{
                  ...
                  whileHover={{
                    scale: 1.02,
                    boxShadow: "0 12px 48px rgba(164, 92, 255, 0.6), inset 0 1px 0 rgba(255, 255, 255, 0.3)",
                  }}
                  whileTap={{ scale: 0.98 }}
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 md:py-16">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 md:gap-12 mb-12">
          ...
          >
            ...
            <p className="text-[#9CA3AF] text-sm font-light leading-relaxed mb-6 max-w-xs">
          ...
          >
            <h4 className="text-[#FFFFFF] font-semibold text-sm uppercase tracking-wider mb-4">
              Produkte
            </h4>
            <ul className="space-y-3">
              {footerLinks.produkte.map((link, index) => (
                <li key={link.label}>
                  <Link
                    href={link.href}
                    className="text-[#9CA3AF] hover:text-[#A45CFF] transition-colors duration-300 text-sm font-light group flex items-center gap-2"
                  >
        ...
        {/* Bottom Bar */}
        <motion.div
          className="pt-8 border-t border-[#A45CFF]/10 flex flex-col md:flex-row justify-between items-center gap-4"
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          viewport={{ once: true }}
