          ...
          <>
            ...
            >
              <div className="flex flex-col h-full p-6">
                ...
                {/* Mobile Search Bar - Apple Intelligence Style */}
                <div className="mb-6">
                  <div
                    ...
                    style={{
                      background: theme === "dark"
                        ...
                        ? "linear-gradient(180deg, rgba(255, 255, 255, 0.98) 0%, rgba(255, 255, 255, 0.95) 50%, rgba(255, 255, 255, 0.92) 100%)"
                        : "linear-gradient(180deg, rgba(255, 255, 255, 0.95) 0%, rgba(255, 255, 255, 0.90) 50%, rgba(255, 255, 255, 0.85) 100%)",
                      backdropFilter: searchFocused ? "blur(100px) saturate(220%)" : "blur(80px) saturate(200%)",
                      WebkitBackdropFilter: searchFocused ? "blur(100px) saturate(220%)" : "blur(80px) saturate(200%)",
                      border: theme === "dark"
                        ? searchFocused
                      ...
                      boxShadow: theme === "dark"
                        ? searchFocused
                          ? "0 12px 48px rgba(0, 0, 0, 0.5), 0 0 0 0.5px rgba(255, 255, 255, 0.18) inset, 0 0 50px rgba(168, 85, 247, 0.25)"
                          : "0 6px 24px rgba(0, 0, 0, 0.4), 0 0 0 0.5px rgba(255, 255, 255, 0.12) inset, 0 0 30px rgba(168, 85, 247, 0.15)"
                        : searchFocused
                        ? "0 12px 48px rgba(0, 0, 0, 0.2), 0 0 0 0.5px rgba(0, 0, 0, 0.1) inset"
                        : "0 6px 24px rgba(0, 0, 0, 0.12), 0 0 0 0.5px rgba(0, 0, 0, 0.08) inset",
                    }}
                  >
                    ...
                    {/* Mobile Search Results - Ultra High z-index */}
                    <AnimatePresence>
                      {showResults && searchResults.length > 0 && (
                        <motion.div
                          className="absolute top-full left-0 right-0 mt-2 max-h-[300px] overflow-y-auto rounded-[20px]"
                          initial={{ opacity: 0, y: -10 }}
                          animate={{ opacity: 1, y: 0 }}
                          exit={{ opacity: 0, y: -10 }}
                          style={{
                            ...
                            isolation: "isolate",
                            background: theme === "dark"
                              ? "linear-gradient(180deg, rgba(0, 0, 0, 0.95) 0%, rgba(0, 0, 0, 0.92) 100%)"
                            ...
                            border: theme === "dark"
                              ...
                              : "1.5px solid rgba(0, 0, 0, 0.18)",
                            boxShadow: theme === "dark"
                              ? "0 24px 96px rgba(0, 0, 0, 0.8), 0 0 0 0.5px rgba(255, 255, 255, 0.2) inset, 0 0 80px rgba(168, 85, 247, 0.3)"
                              : "0 24px 96px rgba(0, 0, 0, 0.25), 0 0 0 0.5px rgba(0, 0, 0, 0.12) inset, 0 0 60px rgba(124, 58, 237, 0.15)",
                          }}
                        >
                          <div className="p-2">
                            {searchResults.map((result, index) => (
                              ...
                              >
                                <motion.div
                                  className={`px-3 py-2.5 rounded-[14px] ${
                                    index === selectedIndex ? "bg-opacity-100" : ""
                                  }`}
                                  style={{
                                    background:
